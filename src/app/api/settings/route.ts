...
const ALLOWED_KEYS = new Set([
  ...
  // Open-source scraper provider (see docs/scraper-provider.md for anti-ban guidance)
  "SCRAPER_PROVIDER","CRAWLEE_PROXY","CRAWLEE_HEADLESS","CRAWLEE_WITH_BROWSER","CRAWLEE_PLAYWRIGHT_FALLBACK","CRAWLEE_MAX_CONCURRENCY","CRAWLEE_STEALTH","CRAWLEE_VERBOSE",
  // All-platform keys (optional)
  "YOUTUBE_API_KEY","LINKEDIN_COOKIE"
]);
